...
Herbert Wander dos Santos Martins herbert-wander@hotmail.com <br>
...
> O sistema Smart-Tracking vai armazenar uma gama de informações, coletadas pelo smart watch e celular do usuário. Será armazenado as informações de vários censores do smart watch, entre eles: Acelerometro, pedômetro, velocidade de caminhada, calorias, distância, giroscópio, magnetômetro, barometro, altimetro, GPS, nivel de luz ambiente, termometro, nivel de raios ultravioleta, galvanometro, microfone e analise do sono. Será armazenado também varias informações do cliente, como: nome, data de nascimento, cpf, endereços (casa,trabalho etc), telefone e email.
O Smart-Tracking irá armazenar outras informações derivadas dos dados dos censores, como os percursos percorridos, lugares visitados, qualidade do sono, quantidade de exercicios práticadas entre outros.
...
![Alt text](https://github.com/MatheusP-Vieira/Smart-Tracking/blob/master/Conceitual_1.png?raw=true "Modelo Conceitual")
